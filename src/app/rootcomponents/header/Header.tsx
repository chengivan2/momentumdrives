...
`}
      ...
      {/* Mobile Navigation */}
      {isMenuOpen && (
        <div className="flex flex-col lg:hidden py-4 px-4 h-auto space-y-3 absolute top-full left-0 right-0 bg-header-bg-color border-t">
          <nav className="">
            <Menu />
          </nav>
          <div className="flex flex-col justify-center items-center gap-[1rem] pt-3 border-t">
            <HeaderButtons />
          </div>
        </div>
      )}
